...
<head>
    ...
    <link rel="stylesheet" href="{{asset('backend/public/bootstrap/css/bootstrap.min.css')}}">
    <link rel="stylesheet" href="{{asset('backend/public/fontawesome/css/all.min.css')}}">
    <script src="{{asset('backend/public/bootstrap/js/bootstrap.min.js')}}"></script>
