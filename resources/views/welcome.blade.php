                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="category-item ch-150">
                            <img src="{{asset('frontend/img/category-5.jpg')}}" />
                            <a class="category-name" href="">
                                <p>Some text goes here that describes the image</p>
                            </a>
                        </div>
                    ...
                    <div class="col-md-3">
                        <div class="category-item ch-150">
                            <img src="{{asset('frontend/img/category-6.jpg')}}" />
                            <a class="category-name" href="">
                                <p>Some text goes here that describes the image</p>
                            </a>
                        </div>
                        <div class="category-item ch-250">
                            <img src="{{asset('frontend/img/category-7.jpg')}}" />
                            <a class="category-name" href="">
                                <p>Some text goes here that describes the image</p>
                            </a>
                        </div>
                    ...
                    <div class="col-md-3">
                        <div class="category-item ch-400">
                            <img src="{{asset('frontend/img/category-8.jpg')}}" />
                            <a class="category-name" href="">
                                <p>Some text goes here that describes the image</p>
                            </a>
                        </div>
                        ...
                        <div class="product-item">
                            ...
                            <div class="product-image">
                                <a href="product-detail.html">
                                    <img src="{{asset('images')}}/{{$p->photo}}" class="img-fluid" alt="Product Image">
                                </a>
                                <div class="product-action">
                                    <a href="{{route('cart.add',$p->id)}}"><i class="fa fa-cart-plus"></i></a>
                            ...
                            <div class="product-price">
                                <h3>{{$p->price}}</h3>
                                <a class="btn" href="{{route('cart.add',$p->id)}}"><i class="fa fa-shopping-cart"></i>Buy Now</a>
                            </div>
                        </div>
                    </div>
